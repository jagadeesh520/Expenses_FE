...
export default function PaymentValidationRegionSelection() {
  const navigate = useNavigate();

  const handleRegionSelect = (region) => {
    navigate("/payment-validation", { state: { region } });
  };
    ...
    >
      <div className="card p-5 shadow-lg" style={{ maxWidth: "500px", width: "100%" }}>
        <div className="text-center mb-4">
          ...
          />
          <h2 className="fw-bold mb-3">Payment Validation</h2>
          <p className="text-muted">Select a region to validate payments</p>
        </div>
